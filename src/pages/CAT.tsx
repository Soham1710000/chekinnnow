...
const socialProof = [
  { name: "IIM Alumni", desc: "From ABC and beyond" },
  { name: "MBB Consultants", desc: "McKinsey, BCG, Bain" },
  { name: "Startup Founders", desc: "Built from B-school" },
  { name: "Working MBAs", desc: "Did it while working" },
];
...
const steps = [
  ...
  {
    title: "We find someone who gets it",
    desc: "Someone who's been exactly where you are now."
  },
  {
    title: "Get connected within 12 hours",
    desc: "Have a real conversation with someone who understands."
  }
];
...
const CAT = () => {
  ...
  const handlePainPointClick = useCallback((painPoint: string) => {
    ...
    sessionStorage.setItem("chekinn_source", "cat");
    trackEvent("cta_click", { variant: "CAT", template: painPoint });
    navigate("/chat");
  }, [navigate, trackEvent]);

  const handleMainCTA = useCallback(() => {
    sessionStorage.setItem("chekinn_source", "cat");
    trackEvent("cta_click", { variant: "CAT", template: "main_cta" });
    navigate("/chat");
  }, [navigate, trackEvent]);
    ...
    <main className="min-h-screen bg-[#FDFCFA] text-[#1C1C1C]">
        ...
        <div className="max-w-[520px] w-full mx-auto space-y-8">
          ...
          <div className="flex justify-center">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs bg-[#F0EDE8] text-[#737373]">
              ...
              <span>40+ MBA aspirants connected</span>
            </div>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-[640px] mx-auto">
          ...
          <p className="text-center mb-12 text-[#808080]">
            People who've walked the MBA path
          </p>
      ...
      <footer className="py-8 text-center">
        <p className="text-xs text-[#999]">
          ChekInn — where MBA aspirants find their people
        </p>
      </footer>
    </main>
  );
